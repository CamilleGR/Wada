    ...
    <div class="container">
      <div class="row">
        <div class="page-header">
          <h1>Courbes <small>cas MinMaxMoy</small></h1>
        </div>
      </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-3">
                    ...
                    <a id="open2" class="btn btn-default btn-xs" data-placement="bottom" data-toggle="popover" data-title="Use client side csv files" data-container="body" type="button" data-html="true" href="#"  >Select data</a>
